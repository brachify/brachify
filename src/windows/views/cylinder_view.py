...
class CylinderView(CustomView):
    ...
    def __init__(self):
        ...
        self.ui.spinbox_length.setValue(get_app().values.config_values["CONFIG_CYLINDER_LENGTH"])
        self.ui.spinbox_diameter.setValue(get_app().values.config_values["CONFIG_CYLINDER_DIAMETER"])
