...
"color: rgb(0, 0, 0);")
        ...
        self.spinbox_base_thickness.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
...
"color: rgb(0, 0, 0);")
        ...
        self.spinbox_base_height.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
...
"")
        ...
        self.cb_add_base.setChecked(False)
