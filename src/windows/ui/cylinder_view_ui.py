...
class Ui_Cylinder_View(object):
    def setupUi(self, Cylinder_View):
        ...
        self.label.setStyleSheet(u"color: rgb(0, 0, 0);background-color: rgb(240, 245, 250);")
        ...
        self.spinbox_diameter.setStyleSheet(u"QDoubleSpinBox {\n"
"    color: rgb(0, 0, 0);\n"
"    background-color: rgb(255, 255, 255);\n"
"    selection-background-color: rgb(180, 210, 240);\n"
...
"}")
        ...
        self.label_2.setStyleSheet(u"color: rgb(0, 0, 0);background-color: rgb(240, 245, 250)")
...
"}")
        ...
        self.label_3.setStyleSheet(u"color: rgb(0, 0, 0);background-color: rgb(240, 245, 250)")
        ...
        self.cb_add_base.setStyleSheet(u"QCheckBox {\n"
"    color: rgb(0, 0, 0);\n"
...
"}")
        ...
        self.spinbox_base_thickness.setStyleSheet(u"QSpinBox {\n"
"    color: rgb(0, 0, 0);\n"
"    background-color: rgb(255, 255, 255);\n"
"    selection-background-color: rgb(180, 210, 240);\n"
"    selection-color: rgb(0, 0, 0);\n"
"}")
        ...
        self.spinbox_base_height.setStyleSheet(u"QSpinBox {\n"
"    color: rgb(0, 0, 0);\n"
"    background-color: rgb(255, 255, 255);\n"
"    selection-background-color: rgb(180, 210, 240);\n"
"    selection-color: rgb(0, 0, 0);\n"
"}")
        ...
        self.label_4.setStyleSheet(u"color: rgb(0, 0, 0);background-color: rgb(240, 245, 250)")

        self.formLayout.setWidget(2, QFormLayout.ItemRole.LabelRole, self.label_4)

        self.label_5 = QLabel(Cylinder_View)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setStyleSheet(u"color: rgb(0, 0, 0);background-color: rgb(240, 245, 250)")
...
"}")
    ...
    def retranslateUi(self, Cylinder_View):
        ...
        self.label_4.setText(QCoreApplication.translate("Cylinder_View", u"Base Thickness", None))
        self.label_5.setText(QCoreApplication.translate("Cylinder_View", u"Base Height", None))
