...
class Ui_Export_View(object):
    def setupUi(self, Export_View):
        ...
        self.cb_tandem_shown.setLayoutDirection(Qt.LeftToRight)
        ...
        sizePolicy1.setHeightForWidth(self.cb_collet_preview_reference_sheet.sizePolicy().hasHeightForWidth())
        self.cb_collet_preview_reference_sheet.setSizePolicy(sizePolicy1)
        self.cb_collet_preview_reference_sheet.setLayoutDirection(Qt.LeftToRight)
