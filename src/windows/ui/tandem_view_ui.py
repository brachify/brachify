...
class Ui_Tandem_View(object):
    def setupUi(self, Tandem_View):
        ...
        self.verticalLayoutWidget = QWidget(Tandem_View)
        ...
        self.tabWidget.setMinimumSize(QSize(200, 300))
        self.tabWidget.setMaximumSize(QSize(400, 16777215))
        self.tabWidget.setAutoFillBackground(False)
        self.tabWidget.setStyleSheet(u"background-color: rgb(240, 245, 250)")
        self.tab_import = QWidget()
        self.tab_import.setObjectName(u"tab_import")
        self.tab_import.setStyleSheet(u"background-color: rgb(240, 245, 250)")
        self.formLayout_5 = QFormLayout(self.tab_import)
...
"}")
        ...
        self.formLayout_5.setWidget(1, QFormLayout.LabelRole, self.btn_import)
...
"}")
        ...
        self.formLayout_5.setWidget(1, QFormLayout.FieldRole, self.btn_clear_import)

        self.label_7 = QLabel(self.tab_import)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setStyleSheet(u"background-color: rgb(240, 245, 250)")

        self.formLayout_5.setWidget(2, QFormLayout.SpanningRole, self.label_7)
        ...
        self.label_8.setStyleSheet(u"background-color: rgb(240, 245, 250)")
        ...
        self.formLayout_5.setLayout(0, QFormLayout.SpanningRole, self.formLayout_2)
...
"	background-color: rgb(28, 44, 81);\n"
"}")
        self.formLayoutWidget_3 = QWidget(self.tab_generate)
        self.formLayoutWidget_3.setObjectName(u"formLayoutWidget_3")
        self.formLayoutWidget_3.setGeometry(QRect(10, 0, 231, 141))
        ...
        self.sb_tandem_height = QDoubleSpinBox(self.formLayoutWidget_3)
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.sb_tandem_height)
        ...
        self.sp_channel_diameter = QDoubleSpinBox(self.formLayoutWidget_3)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.sp_channel_diameter)
        ...
        self.sp_stopper_diameter = QDoubleSpinBox(self.formLayoutWidget_3)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.sp_stopper_diameter)
        ...
        self.sp_bend_angle = QDoubleSpinBox(self.formLayoutWidget_3)
        self.sp_bend_angle.setObjectName(u"sp_bend_angle")
        self.sp_bend_angle.setStyleSheet(u"background-color: rgb(255, 255, 250)")

        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.sp_bend_angle)

        self.label_6 = QLabel(self.formLayoutWidget_3)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setMinimumSize(QSize(100, 0))
        self.label_6.setStyleSheet(u"background-color: rgb(240, 245, 250)")

        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.label_6)

        self.sb_bend_radius = QDoubleSpinBox(self.formLayoutWidget_3)
        ...
        self.label_5.setBuddy(self.sb_tandem_height)
        self.label_4.setBuddy(self.sp_channel_diameter)
        self.label_2.setBuddy(self.sp_stopper_diameter)
        self.label.setBuddy(self.sp_bend_angle)
        self.label_6.setBuddy(self.sb_bend_radius)
    ...
    def retranslateUi(self, Tandem_View):
        ...
        self.label_7.setText(QCoreApplication.translate("Tandem_View", u"Model Details", None))
        self.label_8.setText(QCoreApplication.translate("Tandem_View", u"Height Offset", None))
        ...
        self.label_5.setText(QCoreApplication.translate("Tandem_View", u"Tandem Height", None))
        self.sb_tandem_height.setSuffix(QCoreApplication.translate("Tandem_View", u" mm", None))
        self.label_4.setText(QCoreApplication.translate("Tandem_View", u"Channel Diameter", None))
        ...
        self.label.setText(QCoreApplication.translate("Tandem_View", u"Bend Angle", None))
